export const navLinks = [
  ...
  { href: '#credentials-roles', label: 'Credentials & Roles' },
  { href: '#ecosystem', label: 'Ecosystem' },
];

export const expertiseSectors = [
  {
...
export const sections = [
  ...
  {
    id: 'credentials-roles',
    title: 'Credentials & Roles',
    body: [
      'A distinguished Fellow Chartered Accountant (FCA) with a comprehensive academic foundation comprising a Bachelor of Business Management (BBM) and a Bachelor of Legislative Law (LLB). This unique tri-disciplinary expertise across finance, business administration, and law enables a holistic approach to complex corporate governance and statutory compliance.',
      'Presently serving as Vice President at Viksit Management Consultancy Private Limited, steering strategic financial operations and advisory for high-growth enterprises. Concurrently acts as Director for Adithi Millets Private Limited, guiding the agribusiness toward sustainable market expansion.',
      'As the Founder of the Artha Dharma Financial Literacy Foundation, Mohan is deeply committed to democratizing financial knowledge, empowering rural entrepreneurs, and fostering resilient economic frameworks at the grassroots level.'
    ],
  },
  {
    id: 'ecosystem',
